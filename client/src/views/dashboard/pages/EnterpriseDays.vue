<template>
  <div class="Enterprise-days">
    <div class="Enterprise-days__info">
      <div :class="{ 'block-event': loadData }" class="Enterprise-days__btn" @click='generateDay'>
    ...
    <router-link class="Enterprise-days__day hover-scale-shadow" v-for="(item, index) in pageData.data" :key="index" :to="'/day/'+item.id" >
