<template>
  <div class="Enterprise-day">
    <tabs>
      <tab title="Сенсори">
        <table>
         <tr class="Enterprise-day__table-header">
         ...
         <tr v-for="(item, index) in sensors" :key="index" class="Enterprise-day__table-row">
      ...
      <tab title="Заміри">
        <table>
         ...
         <tr v-for="(item, index) in controls" :key="index" class="Enterprise-day__table-row">
          <td><span>{{item.enterprise_day_id}}</span></td>
          <td><span>{{item.shift_id}}</span></td>
...
export default {
  ...
  methods: {
    ...
    loadPageData(dayId) {
      axios
        .get(
          `${process.env.VUE_APP_URL}/api/day/${dayId}/sensor-data`
        )
        .then(response => {
      ...
      axios
        .get(
          `${process.env.VUE_APP_URL}/api/day/${dayId}/control-data`
        )
        .then(response => {
